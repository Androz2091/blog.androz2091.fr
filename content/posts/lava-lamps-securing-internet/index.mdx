...
> Note : cette présentation d'environ 5 minutes a été rédigée dans le cadre d'un oral de sciences. Les mots clés à accentuer durant la présentation sont en gras.
...
Les lampes à lave sont souvent décrites comme hypnotisantes et possèdent un mécanisme très intéressant qui mélange des notions de thermodynamique et de chimie. Mais saviez-vous que celles-ci permettent aussi de **chiffrer une grande partie du trafic web** ? Et plus exactement, que c’est un mur de cent lampes à lave qui assure aux internautes une connexion sécurisée sur près d’un quart des sites web accessibles au public ?

Nous allons y répondre en commençant par **décrire le fonctionnement **d’une lampe à lave, puis en expliquant pourquoi celle-ci fait **partie des systèmes physiques dits chaotiques** et finalement en quoi elle est **utile en sécurité informatique**.

## Qu’est-ce qu’une lampe à lave ?

Commençons par étudier le fonctionnement d’une lampe à lave. 

La lampe à lave est constituée **d’huile minérale** dans laquelle se trouvent des **bulles de cires colorées**. La densité des bulles de cire, à température ambiante, est légèrement supérieure à celle de l’huile. Cela explique pourquoi les bulles se trouvent au fond de la lampe quand celle-ci est éteinte.

A la base de la lampe, on trouve une** lampe à incandescence** pour chauffer le contenu tout en l’éclairant.

Lorsqu’on allume la lampe, la cire chauffe, devient liquide donc sa densité diminue.

Or, l’huile minérale, elle, ne se dilate pas autant que la cire à la même température. Les bulles de cire deviennent donc moins denses que l’huile et montent dans la lampe.

Il faut noter que même si la cire est devenue liquide, **elle ne se mélange pas** au liquide transparent. Ce sont deux liquides **non miscibles**. Dans un tel mélange, chaque liquide est appelé une phase. Les bulles de cire et l’huile qui les entoure forment donc un mélange biphasique.

Maintenant, pourquoi les bulles de cire moins denses ne restent-elles pas en haut de la lampe ?

Eh bien, une fois en haut du récipient, qui est donc plus froid, la température des bulles diminue, leur densité augmente, et celles-ci retombent au fond de la lampe. C’est le **phénomène de convection en thermodynamique**.
...
On retrouve ces lampes à lave sur beaucoup de bureaux, et il est intéressant de comprendre leur fonctionnement.

Le fait que leur imprévisibilité permette de résoudre un problème de génération de nombres aléatoires, en les impliquant dans une très grande partie du trafic web mondial, les rend encore plus fascinantes.
