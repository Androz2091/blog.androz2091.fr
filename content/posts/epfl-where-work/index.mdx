...
Pour optimiser ça, je me suis dit qu'il pourrait être intéressant de permettre de lister les quelques salles proches de soi disponibles.
...
Bon. Après avoir ouvert le portail de l'EPFL et inspecter quelques requêtes, je vois qu'on peut effectivement récupérer des points pour chaque salle. 
...
Donc là, je suis content. Jusqu'à lire les coordonnées. En tant que français peu expérimenté en carto... je me demande pourquoi ce site ne renvoie pas comme habituellement des coordonnées latitude/longitude mais des coordonnées immenses allant jusqu'à 2M.
