...
Ici, nous voulons plusieurs endpoints pour notre API :
* `GET /salles/near?loc=46.38894987,5.948839` (loc est la latitude et la longitude)
* `GET /salles/near?loc=46.38894987,5.948839&filter=CM1*` (filter est un filtre sur le nom des salles)
