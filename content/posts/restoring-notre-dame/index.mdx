...
Il est donc possible d’optimiser ces calculs en utilisant des approximations pour réduire leur nombre. L'idée est de créer des “boîtes” pour englober les polyèdres. Ces boîtes sont des formes géométriques simples, comme des parallélépipèdes ou des sphères. En calculant la distance entre un point et la boîte, on obtient une approximation de la distance entre le point et le polyèdre.
