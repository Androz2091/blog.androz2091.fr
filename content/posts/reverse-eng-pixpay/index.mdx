...
Cet article me sert à la fois de notes dans le cas où j'aurais à faire de nouveau cela avec une  autreapplication, et à la fois de tutoriel pour que vous puissiez (peut-être) apprendre quelques petites choses !
...
## [Flutter](http://flutter.dev/), le framework Android... qui ne suit pas les paramètres Android
