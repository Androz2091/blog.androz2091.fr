...
L'unique configuration de piratage qui est donc encore avantageuse aujourd'hui, c'est une configuration où **tout** est automatisé : du téléchargement du film à sa mise à disposition sur un service de streaming privé. Et c'est déjà tout à fait possible.
