...
20h02 : Le film piraté se lance en HD, audio et sous-titres disponibles dans toutes les langues... sans aucun centime dépensé.
...
**Partie 2 : automatiser et publier.**

Vous saurez également comment automatiser le téléchargement depuis ces sources grâce à **Radarr**, **Sonarr** ou encore **Overseerr**.

Enfin, vous saurez comment rendre disponible au public vos films, en les **hébergeant** sur un serveur grâce à **Plex** ou **Jellyfin**.
