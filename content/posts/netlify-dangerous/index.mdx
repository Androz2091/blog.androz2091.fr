...
En tant que développeur, Netlify peut sembler une excellente solution. En effet, cet outils vous permet de **déployer automatiquement vos applications web** lorsque vous effectuez un commit sur le repository github du projet. De plus, vous pouvez bénéficier de prévisualisations automatiques des pull requests de votre repo, ainsi que de nombreux paramètres de configuration de votre site.

C'est un outils formidable pour tous les développeurs web qui souhaitent publier leurs sides-projects facilement, **sans avoir à gérer un serveur virtuel privé (VPS)**, et, surtout, **sans avoir à build et déployer l'application manuellement** à chaque changement. Le tout **gratuitement**.
