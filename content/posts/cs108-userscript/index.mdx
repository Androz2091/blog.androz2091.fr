---
title: (CS-108) Créer un userscript pour lire la consigne
date: 2024-03-01
...
* souvent, le nom des méthode à créer n'est pas assez mis en avant
...
> Le résultat final nous permettra de mettre en avant les méthodes, et d'ajouter un lien pour jumper aux conseils de programmation sans attendre
